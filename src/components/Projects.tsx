...
function Projects() {
    return (
        <section id="projects">
            ...
            <p className="font-medium max-w-[28rem] md:text-center md:mx-auto">Untuk karya/project biasanya saya upload di Instagram atau Github untuk sekedar publishing/promosi atau hanya sekedar untuk menyimpan nya saja.</p>
